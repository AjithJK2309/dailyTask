var userInp = require("prompt-sync");
var getInput = userInp();
var Input = parseInt(getInput("Enter the value between 1-7... "));
var Input2 = Input < 8 && Input > 0 ? Input : console.log("Please Enter Value Between 1 to 7... ");
switch (Input2) {
    case 1:
